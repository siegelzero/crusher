    ...
    for cons in carray.constraints:
        ...
        for d in carray.domain[pos]:
            ...
            case cons.stateType:
                ...
                of AllDifferentType, AtLeastType, AtMostType, ElementType, OrderingType, GlobalCardinalityType, MultiknapsackType, SequenceType, BooleanType, CumulativeType, GeostType, IrdcsType, CircuitType, SubcircuitType, UnionCycleType, InvolutionType, ConnectedType, AllDifferentExcept0Type, LexOrderType, TableConstraintType, RegularType, CountEqType, NValueType, DiffnType, DiffnKType, MatrixElementType, NoOverlapFixedBoxType, ConditionalCumulativeType, ConditionalNoOverlapPairType, ConditionalDayCapacityType, DisjunctiveClauseType, AdjacencyEqualType, ValueSupportType, MultiResourceNoOverlapType, CircuitTimePropType, MultiMachineNoOverlapType, ConditionalLinearType, ReservoirType, SetIntersectCardType, ConjunctSumAtMostType, PseudoBoolLinLeType:
